        ...
        !isMobile ?
          ...
          <div className="text-white relative">
            ...
            <div className="absolute items-center flex justify-center flex-col bottom-0 left-1/2 transform w-full -translate-x-1/2 -translate-y-1/2 text-center text-xl font-semibold px-4">
              <p className="text-xl font-semibold whitespace-nowrap">CRIE SEM LIMITES</p>
              <p className="text-4xl font-bold"> Soluções avançadas de produção virtual e gráficos em tempo real</p>
