      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            ...
            <div className="flex flex-col md:flex-row w-full justify-center md:justify-start gap-4">
              <div>
                <a
                  className="me-6 [&>svg]:h-4 [&>svg]:w-4 flex gap-4 items-center hover:text-orange-600">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 320 512">
